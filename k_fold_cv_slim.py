# -*- coding: utf-8 -*-
"""K-Fold CV_SLIM.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1xRtA9vgIP_hX7yDTMPEnmwSYf5aAHM7c
"""
...
def train_and_evaluate(recommender_args):
    ...
    recommender_instance = SLIMElasticNetRecommender(URM)
    recommender_instance.fit(
        ...
        l1_ratio=hyperparams['l1_ratio']  # Accessing the hyperparameter from the dictionary
    )
...
def objective_function(optuna_trial):
    ...
    hyperparams = {
        'topK': optuna_trial.suggest_int("topK", 200, 300),
        'alpha': optuna_trial.suggest_float("alpha", 0.001, 0.1),
        'l1_ratio': optuna_trial.suggest_float("l1_ratio", 1e-6, 1e-4)
    }
